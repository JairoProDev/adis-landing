# Kit de mensajes — Clientes ADIS (outreach personal)
...
## 1. Apertura fría (no conoces negocio)

```
Hola! Soy Shantall, de ADIS — ayudamos negocios en Cusco con presencia digital.

Quise escribirte porque [vi tu perfil / nos recomendaron / nos encontré con tu negocio].

¿Cómo te va con [tu emprendimiento / tu negocio]? ¿Cómo se llama lo tuyo? Me encantaría saber qué haces 😊
```

---

## 2. Apertura tibia (contacto previo, feria, referido)

```
Hola [nombre]! Shantall por acá, de ADIS.

[Te vi en X / Hablamos hace un tiempo / [nombre] me pasó tu contacto] — quise retomar porque estamos acompañando negocios con su parte digital.

¿Sigues con [rubro]? ¿Cómo te ha ido últimamente?
```

---

## 3. Mensaje con interés (después de escuchar su negocio)
...
¿Alguna duda? Estamos para atenderte.
```
...
## 5. Seguimiento si abrieron adis.lat y no pagaron (24–48 h)
...
Quedan [X] de 10 cupos.

Yape 990 551 461 → captura al 937 054 328

Sin presión — solo por si te sirve la info 💜
```

---

## 6. Respuesta al pagar

```
¡Recibido, [nombre]! 🎉 Tu cupo para el programa 3 meses está CONFIRMADO.

Arrancamos Entregable 1 (investigación digital) en los próximos días.

Te escribimos con tu calendario de 90 días y primeros pasos.

Mientras tanto, mándanos:
1) Nombre de tu negocio
2) Link de Instagram o Facebook (si tienes)
3) 3 fotos de tus productos por WhatsApp
...
## 8. Broadcast Shantall (contactos propios / redes)

```
Hola! Soy Shantall, de ADIS.

Este trimestre abrimos cupos para acompañar negocios con su presencia digital:
...
📲 Shantall · 990 551 461
```

---

## Qué NO decir (vs qué SÍ decir)
...
| Solo el link | Texto + contexto + link cuando pidan |
...
- [ ] Actualizar cupos reales ([X] de 10)
- [ ] Personalizar `[nombre]` y `[negocio]`
...
| Rol | Número |
|-----|--------|
| WhatsApp empresa (capturas) | 937 054 328 |
...
- **`OFERTA-ADIS-COMPLETA.md`** — calendario 90 días, mensajes, valor ref.
- **`MANUAL-OUTREACH-ADIS.md`** — método AIDA, plantillas, seguimiento
